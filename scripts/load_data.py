...
SCHEMAS = {
    ...
    "asm_qtl": [
        ...
        bigquery.SchemaField("most_severe", "STRING"),
        bigquery.SchemaField("gene_most_severe", "STRING"),
        bigquery.SchemaField("target_start", "INT64"),
        bigquery.SchemaField("target_end", "INT64"),
        bigquery.SchemaField("ref_methylrate", "FLOAT64"),
        bigquery.SchemaField("alt_methylrate", "FLOAT64"),
        bigquery.SchemaField("n_haplotypes", "INT64"),
        bigquery.SchemaField("variant_rank", "STRING"),
        bigquery.SchemaField("ld_count", "INT64"),
        bigquery.SchemaField("vartype", "STRING"),
    ],
    # column order must match TSV file exactly
