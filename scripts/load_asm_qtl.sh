...
ASM_QTL_FILES=(
  "gs://${GCS_BUCKET}/${GCS_PREFIX}asm_qtl/deCODE_asmQTL_CpG.munged.tsv.gz"
  "gs://${GCS_BUCKET}/${GCS_PREFIX}asm_qtl/deCODE_asmQTL_MDS.munged.tsv.gz"
)

echo ""
ts "=== Loading ASM-QTL results ==="
first_asm_qtl=true
for gcs_uri in "${ASM_QTL_FILES[@]}"; do
