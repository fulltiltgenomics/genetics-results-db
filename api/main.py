...
VIEWS = ["credible_sets_v", "colocalization_v", "coloc_credsets_v", "exome_variant_results_v", "gene_burden_results_v", "gene_annotations_v", "open_chromatin_v", "variant_effect_v"]
