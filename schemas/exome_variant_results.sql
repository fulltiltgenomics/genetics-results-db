...
(
  ...
  annotation STRING OPTIONS(description="Variant annotation (pLoF, missense, synonymous, splice_region_variant, etc.)"),
  ...
  trait_original STRING OPTIONS(description="Original trait name in the respective dataset")
)
