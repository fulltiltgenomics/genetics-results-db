...
(
  ...
  rsid STRING NOT NULL OPTIONS(description="dbSNP rsID"),
  ...
  af FLOAT64 NOT NULL OPTIONS(description="Allele frequency"),
  ...
  target_start INT64 NOT NULL OPTIONS(description="Methylation target region start position"),
  target_end INT64 NOT NULL OPTIONS(description="Methylation target region end position"),
  ref_methylrate FLOAT64 NOT NULL OPTIONS(description="Methylation rate on reference haplotype"),
  alt_methylrate FLOAT64 NOT NULL OPTIONS(description="Methylation rate on alternate haplotype"),
  n_haplotypes INT64 NOT NULL OPTIONS(description="Number of haplotypes used in analysis"),
  variant_rank STRING NOT NULL OPTIONS(description="Variant rank: primary or secondary"),
  ld_count INT64 OPTIONS(description="Number of variants in LD with this variant"),
  vartype STRING NOT NULL OPTIONS(description="Variant type: SNV, SV, etc.")
)
